...
<head>
    ...
    <title>Gestor <?php echo $this->renderSection('titulo'); ?> </title>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    <!-- Navbar Header--><a href="index.html" class="navbar-brand">
                        <div class="brand-text brand-big visible text-uppercase"><strong class="text-success">Gestor</strong><strong>&nbspEmpresarial</strong></div>
                        <div class="brand-text brand-sm"><strong class="text-success">G</strong><strong>E</strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
                ...
                <div class="right-menu list-inline no-margin-bottom">
                    ...
                    <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1">5</span></a>
                        <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#" class="dropdown-item message d-flex align-items-center">
                                <div class="profile"><img src="<?php echo site_url('recursos/img/usuario_sem_imagem.png') ?>" alt="..." class="img-fluid">
    ...
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                <div class="avatar"><img src="<?php echo site_url('recursos/img/usuario_sem_imagem.png') ?>" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
            ...
            <footer class="footer">
                <div class="footer__block block no-margin-bottom">
                    <div class="container-fluid text-center">
                        <p class="no-margin-bottom"><?php echo date('Y') ?> &copy; Sistema de Gestão Empresarial </p>
                    </div>
                </div>
            </footer>
        </div>
